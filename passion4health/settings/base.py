"""
Django settings for passion4health project.
...
ROOT_URLCONF = "passion4health.urls"
...
WSGI_APPLICATION = "passion4health.wsgi.application"
...
WAGTAIL_SITE_NAME = "passion4health"
...
EMAIL_USE_TLS = True  # For TLS (should be True when using port 587)
